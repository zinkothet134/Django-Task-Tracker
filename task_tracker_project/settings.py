...
# 👇 ADD THIS HERE
ACCOUNT_SIGNUP_FORM_CLASS = "tasks.forms.OrganizationSignupForm"
...
if not DEBUG:
    STORAGES = {
        "staticfiles": {
            # We use 'CompressedStaticFilesStorage' instead of 'Manifest'
            # This is safer because it won't crash if a CSS file points to a missing image
